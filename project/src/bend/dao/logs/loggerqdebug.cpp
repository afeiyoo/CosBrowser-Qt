...
LoggerQDebug::LoggerQDebug(QObject *parent) : BasicLogger(parent) { qInstallMessageHandler(handle); }

LoggerQDebug::~LoggerQDebug() {}

void LoggerQDebug::print(const QString &file, int line, const QString &func, void *tid, int level, const QVariant &var,
                         bool up) {
    QDateTime dt;
